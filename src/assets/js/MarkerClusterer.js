...
(function(){
     ...
     * @return Point
     */
	Cluster.prototype.getClusterPoint = function () {
		return new BMap.Point(this._center.lng,this._center.lat);
	}
	
	/**
     * 设置单击事件 并且设置单击聚合物后是否自动缩放
     * @return 无返回值。
     */
	MarkerClusterer.prototype.addClickListener = function(handler,isAtutoZoom) {
        _click_handler = handler;
		_isAutoZoom = isAtutoZoom;
    };
